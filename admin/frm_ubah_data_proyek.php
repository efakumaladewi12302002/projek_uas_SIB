...
<input type="number" name="dana_proyek" value="<?php echo
...
<input type="date" name="tanggal_proyek" value="<?php echo
date("Y-m-d",strtotime($rs['tanggal_proyek'])) ?>" class="form-control">
</div>
<div class="mb-3">
