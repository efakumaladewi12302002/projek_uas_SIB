...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
 ...
 <!-- <h4>Data Jadwal Kegiatan</h4> -->
    <a href="frm_tambah_pemasok.php" class="btn btn-sm btn-primary">Tambah Data</button></a>
        <br> <br>
 ...
 ?>
                <tr>
                    ...
                    <td><?php echo $rs['tlpn_pemasok']; ?></td>
                <td>
        <a href="frm_ubah_data_pemasok.php?id_pemasok=<?=
$rs['id_pemasok']; ?>"
    class="btn btn-info btn-sm">Ubah</a>
        <a href="hapus_data_pemasok.php?id_pemasok=<?= $rs['id_pemasok']; ?>" class=" btn btn-danger
btn-sm">Hapus</a>
 </td>
 </tr>
 <?php
